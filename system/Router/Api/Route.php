...
class Route {
    public static function get($url,$executeMethod,$name = null){
        ...
        global $gl_routes;
        array_push($gl_routes['get'],array("url" =>  trim("api" . $url,"/"),"class" => "api\\" . $class,"method" => $method,"name" => $name));
    }
    ...
    public static function post($url,$executeMethod,$name = null){
        ...
        $method = $executeMethod[1];
        global $gl_routes;
        array_push($gl_routes['post'],array("url" => trim("api" . $url,"/"),"class" => "api\\" . $class,"method" => $method,"name" => $name));
    }
    ...
    public static function put($url,$executeMethod,$name = null){
        ...
        $method = $executeMethod[1];
        global $gl_routes;
        array_push($gl_routes['put'],array("url" => trim("api" . $url,"/"),"class" => "api\\" . $class,"method" => $method,"name" => $name));
    }
    ...
    public static function delete($url,$executeMethod,$name = null){
        ...
        $method = $executeMethod[1];
        global $gl_routes;
        array_push($gl_routes['delete'],array("url" => trim("api" . $url,"/"),"class" => "api\\" . $class,"method" => $method,"name" => $name));
    }
}